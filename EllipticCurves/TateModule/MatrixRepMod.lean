...
open Classical in
/-- **The mod-`n` matrix representation exists at every `3`-smooth `n > 1`**, on `(2 : F) ≠ 0` and
`(3 : F) ≠ 0`, as a representation that really does compute the Galois action and whose determinant
is the basis-free character.
