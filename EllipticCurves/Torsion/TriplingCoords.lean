...
coordinates.  Above them is the class-group computation,
`EllipticCurves.FunctionField.PullbackPrincipalityThree`, which discharges `hprin` at `n = 3` over
an algebraically closed base field.  The count the fibre description is matched
