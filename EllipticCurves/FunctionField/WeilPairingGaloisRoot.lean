...
missing there is the `[3]` fibre description — one rung, both of whose inputs are merged
(`EllipticCurves.Torsion.TriplingCoords`, `EllipticCurves.FunctionField.MulByThreeRamification`;
see `EllipticCurves.FunctionField.MulByTwoFibreAffine`'s scope note) — and not anything about the
...
the rung-5 data below has to be supplied.  That gap is the `[3]` fibre description — not `#404`,
which is the general `ωₙ`, and not anything Galois-theoretic. -/
