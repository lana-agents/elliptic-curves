...
missing there is the `[3]` fibre description (`#404`; `#763`'s count `4` is `[2]`-specific), not
anything about the Galois action — the `n = 3` engine instance is proved here and is waiting.
...
the rung-5 data below has to be supplied.  That gap is the `[3]` fibre description (`#404`), not
anything Galois-theoretic. -/
