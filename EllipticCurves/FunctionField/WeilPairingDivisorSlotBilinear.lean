...
different statement; any change to `WeilPairingAntisymmetric{,Mu}`'s or `#845`'s proofs.
...
example : ∃ gS gT gR : (y2EqX3SubX AlgClosedQ).FunctionField,
...
nameable. -/
example : ∃ gS gT gR : (y2AddYEqX3 AlgClosedQ).FunctionField,
