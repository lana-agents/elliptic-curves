...
* **`hprin` at `n = 3`, and therefore `#418`.**  Two rungs above this one, and merged there:
  `EllipticCurves.FunctionField.MulByThreeFibre` then
  `EllipticCurves.FunctionField.PullbackPrincipalityThree`.  Do not read
