...
slot `S` (`g_{S ⊕ S'} = g_S · g_{S'}` up to a constant) remains gated on rung 4; alternating
(`e_n(S, S) = 1`) and Galois-equivariance are separate #419 sub-items; non-degeneracy is Ward-gated
(#242).
